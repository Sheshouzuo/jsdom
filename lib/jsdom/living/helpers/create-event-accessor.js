...
const bodyInheritedAttributes = exports.bodyInheritedAttributes = new Set([
  "blur", "error", "focus", "load", "resize", "scroll"
]);

exports.isInheritedAttribute = function isInheritedAttribute(name, el) {
  return bodyInheritedAttributes.has(name) && (el.tagName === "BODY" || el.tagName === "FRAMESET");
};
...
exports.createEventAccessor = function createEventAccessor(obj, event) {
  Object.defineProperty(obj, "on" + event, {
    get() { // https://html.spec.whatwg.org/#getting-the-current-value-of-the-event-handler
      if (exports.isInheritedAttribute(event, this)) {
